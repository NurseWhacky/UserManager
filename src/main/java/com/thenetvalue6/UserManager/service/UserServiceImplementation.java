...
public class UserServiceImplementation implements UserService, UserDetailsService {
    ...
    private User validateUsernamaAndEmail(String oldUsername, String newUsername, String newEmail) throws Exception, EmailExistsException {
        ...
        if (StringUtils.isNotBlank(oldUsername)) {
            ...
            if (currentUser == null) {
                throw new Exception("User with username " + oldUsername + " not found!");
            }
